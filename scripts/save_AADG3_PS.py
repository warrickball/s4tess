...
parser.add_argument('--nameout', type=str, default=None,
                    help="alternative name for AADG3 output "
                    "(if you don't want to use the file in AADG3_input)")
